...
import { Patient, PatientOverview } from 'src/app/modules/patient/interfaces/patient.interfaces';
...
export class AddNoteComponent implements OnInit{
  ...
  requestPatients(args: SelectPersonArgs){
    ...
    return this.patientsService.getDrPatients(this.doctor_id, args.search)
    .pipe(
      catchError((err) => {
        if(err.status !== 404)
